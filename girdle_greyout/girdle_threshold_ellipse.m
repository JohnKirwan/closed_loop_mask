...
usbcam.Resolution =  '800x600'; %; % set highest res '1280x720';
...
while i <= length(randz)
    if randz(i) == 1
        ...
        disp(datetime('now'));
        usb_img = greyout_ellipse0_1(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        sumImage = double(snapshot(usbcam)); %inialise the first image
         for j=2:im_reps %read in remaining images
    ...
    elseif randz(i) == 2
        ...
        disp(datetime('now'));
        usb_img = greyout_ellipse0_3(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        sumImage = double(snapshot(usbcam)); %inialise the first image
         for j=2:im_reps %read in remaining images
    ...
    elseif randz(i) == 3
        ...
        disp(datetime('now'));
        usb_img = greyout_ellipse0_5(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        sumImage = double(snapshot(usbcam)); %inialise the first image
         for j=2:im_reps %read in remaining images
    ...
    elseif randz(i) == 4
        ...
        disp(datetime('now'));
        usb_img = greyout_ellipse0_6(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        sumImage = double(snapshot(usbcam)); %inialise the first image
         for j=2:im_reps %read in remaining images
    ...
    elseif randz(i) == 5
        ...
        disp(datetime('now'));
        usb_img = greyout_ellipse0_7(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        info(i,3) = '7%';  
    elseif randz(i) == 6
        disp('Girdle White');
        disp(datetime('now'));
        usb_img = greyout_ellipse_1(threshold,invtform,girdle_proportion,valve_proportion,...
                usbcam,cam_crop,outputView,f,im_reps,"girdle"); % RUN THE GIRDLE BLACKOUT SCRIPT
        pause(3);
        info(i,3) = 'Control';       
    else
