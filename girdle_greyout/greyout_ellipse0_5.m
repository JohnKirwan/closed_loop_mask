function [usb_img] = greyout_ellipse0_5(threshold,invtform,girdle_proportion,valve_proportion,usbcam,cam_crop,outputView,figure_h,im_reps,part)
...
new_blob = transformed_blob + 0.5; % new line to remakes blob
