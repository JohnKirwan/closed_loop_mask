function [usb_img] = greyout_1(threshold,invtform,girdle_proportion,valve_proportion,usbcam,cam_crop,outputView,figure_h,im_reps,part)
...
new_blob = transformed_blob + 1 ; % new line to remakes blob
